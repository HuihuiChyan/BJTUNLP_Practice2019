...
class multi_filter_attention_CNN():
	...
	def feature(self):
		...
		self.feature = tf.reshape(self.pooled_output, [-1, len(self.filter_list)*256])
	...
	def fc_layer(self):
		...
		output = tf.reshape(self.feature, [-1, len(self.filter_list) * 256])
